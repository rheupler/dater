    ...
    if (domValue) {
        ...
        if (t == 'array' || t == 'object') {
            ...
            if (this.editor.mode.edit) {
				...
				domValue.id="kishan";
				//$(domValue).prepend("<img src='http://farm4.staticflickr.com/3705/10477888884_2bf0e6167d_z.jpg' width='4px' height='4px'>");
				//domValue.title = "<img src='"+v+"'>";
...
Node.prototype.onEvent = function (event) {
	...
	if (type == 'mouseover') {
        this.onMouseover(domValue);
    }
};


Node.prototype.onMouseover = function (domValue) {
if(util.isUrl(domValue.innerHTML)){
$(domValue).tooltipster({content:"<img style='width:200px !important;height:200px !important;' src="+domValue.innerHTML+">",position:"right",contentAsHTML : true});
}
}
/**
